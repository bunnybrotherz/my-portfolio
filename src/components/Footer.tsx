...
const Footer = () => {
  return <footer id="contact" className="py-10 sm:py-16 px-4 sm:px-6 relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto">
        ...
        duration: 0.6
          ...
          <p className="text-muted-foreground text-base max-w-lg mx-auto mb-8">
            I'm currently looking for full-time opportunities starting June 2026. Feel free to reach out!
          </p>

          {/* Social Icons Row */}
          <div className="flex items-center justify-center gap-6 mb-8">
            <motion.a href="mailto:jeslynwjx@gmail.com" className="p-3 rounded-full bg-secondary/50 border border-border hover:border-primary/50 hover:bg-primary/10 transition-all group" whileHover={{
            scale: 1.1
          }} whileTap={{
            scale: 0.95
          }}>
            ...
            <motion.a href="https://www.linkedin.com/in/jeslyn-wang-89b28a236" target="_blank" rel="noopener noreferrer" className="p-3 rounded-full bg-secondary/50 border border-border hover:border-primary/50 hover:bg-primary/10 transition-all group" whileHover={{
            scale: 1.1
          }} whileTap={{
            scale: 0.95
          }}>
            ...
            <motion.a href="https://github.com/bunnybrotherz" target="_blank" rel="noopener noreferrer" className="p-3 rounded-full bg-secondary/50 border border-border hover:border-primary/50 hover:bg-primary/10 transition-all group" whileHover={{
            scale: 1.1
          }} whileTap={{
            scale: 0.95
          }}>
