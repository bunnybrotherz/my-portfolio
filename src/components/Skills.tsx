...
const skills = [
  ...
  { name: "Adobe Photoshop", color: "from-blue-500 to-cyan-500" },
  { name: "Canva", color: "from-cyan-500 to-teal-500" },
  { name: "Capcut", color: "from-pink-500 to-rose-500" },
  { name: "C#", color: "from-violet-500 to-purple-500" },
  { name: "Ruby", color: "from-red-500 to-rose-500" },
  ...
  { name: "Google Cloud Platform", color: "from-blue-500 to-green-500" },
  { name: "Git", color: "from-orange-600 to-red-600" },
  { name: "Postman", color: "from-orange-500 to-amber-500" },
  { name: "Unity", color: "from-gray-600 to-gray-800" },
    ...
    <section className="py-8 px-6 overflow-hidden relative">
      ...
      <div className="max-w-6xl mx-auto mb-8">
        ...
        >
          ...
          <span className="font-mono text-sm text-primary font-medium">TOOLS & TECHNOLOGIES</span>
        </motion.div>
      </div>
